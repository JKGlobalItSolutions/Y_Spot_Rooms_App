...
class HomeScreen extends StatefulWidget {
  ...
  static late String roomCount = "";
  static late String guestCount = "";
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _updateDropdownValue() {
    setState(() {
      ...
      HomeScreen.guestCount = '$_adults Ad + $_children C';
      HomeScreen.roomCount = '$_rooms';
    });
  }
  ...
  Future<void> _selectDateRange(BuildContext context) async {
    ...
    await showDialog(
      ...
      builder: (BuildContext context) {
        ...
        final maxDate = DateTime(currentDate.year, 12, 31);
        ...
        return AlertDialog(
          content: SizedBox(
            ...
            child: SfDateRangePicker(
              ...
              maxDate:
                  maxDate, // Set maximum date to the end of the current year
    ...
    if (pickedRange != null) {
      setState(() {
        _selectedRange = pickedRange!;
        DateTime startDate = _selectedRange!.startDate!;
        DateTime endDate = _selectedRange!.endDate!;
        int daysCount = endDate.difference(startDate).inDays +
            1; // +1 because inclusive of both start and end dates
        HomeScreen.formattedDate =
            '${DateFormat('dd/MM/yyyy').format(startDate)} - ${DateFormat('dd/MM/yyyy').format(endDate)}';
        HomeScreen.checkinDate =
            '${DateFormat('dd/MM/yyyy').format(startDate)}';
        HomeScreen.checkoutDate = '${DateFormat('dd/MM/yyyy').format(endDate)}';
        HomeScreen.daysCount = daysCount.toString();
        print('Selected date range: $daysCount days');
      });
    }
  }
